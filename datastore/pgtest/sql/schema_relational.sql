...
-- MODELS_YML_CHECKSUM = 'a8e96bb1ed50e3ce5d74b02978052513'
...
CREATE TABLE poll_config_option_t (
    ...
    CONSTRAINT valid_poll_config_id_part1 CHECK (split_part(poll_config_id, '/', 1) IN ('poll_config_selection','poll_config_rating_score','poll_config_rating_approval')),
    weight integer,
    text varchar(256),
    meeting_user_id integer
);
...
CREATE VIEW "poll_config_approval" AS SELECT * FROM poll_config_approval_t p;
...
FIELD 1Gr:1rR,1rR,1rR,1rR => poll/config_id:-> poll_config_approval/poll_id,poll_config_selection/poll_id,poll_config_rating_score/poll_id,poll_config_rating_approval/poll_id
...
FIELD 1rR:1Gr => poll_config_approval/poll_id:-> poll/config_id

FIELD 1rR:1Gr => poll_config_selection/poll_id:-> poll/config_id
SQL nt:1GrR => poll_config_selection/option_ids:-> poll_config_option/poll_config_id

FIELD 1rR:1Gr => poll_config_rating_score/poll_id:-> poll/config_id
SQL nt:1GrR => poll_config_rating_score/option_ids:-> poll_config_option/poll_config_id

FIELD 1rR:1Gr => poll_config_rating_approval/poll_id:-> poll/config_id
SQL nt:1GrR => poll_config_rating_approval/option_ids:-> poll_config_option/poll_config_id

FIELD 1GrR:nt,nt,nt => poll_config_option/poll_config_id:-> poll_config_selection/option_ids,poll_config_rating_score/option_ids,poll_config_rating_approval/option_ids
