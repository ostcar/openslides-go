...
var collectionFields = [...]collectionField{
	...
	{"user", "poll_option_poll_id"},
	{"user", "poll_voted_ids"},
	{"user", "pronoun"},
	{"user", "represented_vote_ids"},
	{"user", "saml_id"},
	{"user", "title"},
	{"user", "username"},
	{"vote", "A"},
...
func collectionFieldToID(cf string) int {
	...
	case "poll/config":
		return 680
	case "poll/config_option_user_ids":
		return 681
	...
	case "user/poll_candidate_ids":
		return 912
	case "user/poll_option_poll_id":
		return 913
	case "user/poll_voted_ids":
		return 914
	case "user/pronoun":
		return 915
	case "user/represented_vote_ids":
		return 916
	case "user/saml_id":
		return 917
	case "user/title":
